...
extern int cam_debug_mask;

#define CAM_USER_G0(x...) \
	do { \
		if (cam_debug_mask & FIH_DEBUG_ZONE_G0) \
			fih_printk(cam_debug_mask, FIH_DEBUG_ZONE_G0, x); \
	} while (0)

#define CAM_USER_G1(x...) \
	do { \
		if (cam_debug_mask & FIH_DEBUG_ZONE_G1) \
			fih_printk(cam_debug_mask, FIH_DEBUG_ZONE_G1, x); \
	} while (0)

#define CAM_USER_G2(x...) \
	do { \
		if (cam_debug_mask & FIH_DEBUG_ZONE_G1) \
			fih_printk(cam_debug_mask, FIH_DEBUG_ZONE_G2, x); \
	} while (0)

#ifdef CDBG
#undef CDBG
#endif
#define CDBG CAM_USER_G2

//temporate to solve compile error
//#ifdef CAM_USER_G0
//#undef CAM_USER_G0
//#endif
//#ifdef CAM_USER_G1
...
//#undef CAM_USER_G2
//#endif
//#define CAM_USER_G0(fmt, args...) do { } while (0)
//#define CAM_USER_G1(fmt, args...) do { } while (0)
//#define CAM_USER_G2(fmt, args...) do { } while (0)
#endif
/* } FIH, Charles Huang, 2009/12/28 */
