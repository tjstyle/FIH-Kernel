...
typedef enum
{
  ...
  SMEM_PROC_COMM_OEM_VREG_LED_CONTROL,    
  SMEM_PROC_COMM_OEM_MPP_ISINK,            
  SMEM_PROC_COMM_OEM_CHG_EN,		
  SMEM_PROC_COMM_OEM_ENABLE_HOOKSWITCH,
  SMEM_PROC_COMM_OEM_DISABLE_HOOKSWITCH,
  SMEM_PROC_COMM_OEM_CHG_UI_EVNT_READ,
  SMEM_PROC_COMM_OEM_ALLOC_SD_DL_INFO, //SW2-5-2-SY-OTA-00+
...
//SW2-5-2-SY-OTA-00- #define SMEM_PROC_COMM_OEM_ALLOC_SD_DL_INFO   SMEM_PROC_COMM_OEM_NUM_CMDS
...
// --- for SD card download, paul huang
  ...
  SMEM_PRPC_COMM_OEM_FUSE_WRITE,
  SMEM_PRPC_COMM_OEM_FUSE_READ,
  //FIH, NeoChen, Check FUSE for adjusting AXI & ARM11 clock, 2010/07/27 --
