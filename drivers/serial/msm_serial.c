...
#include <../devices.h>
#include <mach/gpio.h> //SW2-5-1-BH-DbgCfgTool-00+
#endif
 //SW2-5-1-BH-DbgCfgTool-00+]
...
/* FIH, Debbie, 2010/01/04 { */
#ifdef CONFIG_FIH_FXX
static uint32_t serial_debug_mask = 0;
module_param_named(debug_mask, serial_debug_mask, uint, 0644);
#endif
/* FIH, Debbie, 2010/01/04 } */
...
/* FIH, Charles Huang, 2009/05/13 { */
/* [FXX_CR], set for workable but not final */
#ifdef CONFIG_FIH_FXX
...
//SW2-5-1-BH-DbgCfgTool-00+[
	...
	gpio_tlmm_config(GPIO_CFG(86, 0, GPIO_INPUT, GPIO_NO_PULL, GPIO_2MA), GPIO_DISABLE);
	gpio_tlmm_config(GPIO_CFG(87, 0, GPIO_INPUT, GPIO_NO_PULL, GPIO_2MA), GPIO_DISABLE);
