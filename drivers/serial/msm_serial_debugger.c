...
/* FIH, Debbie, 2010/01/04 { */
#ifdef CONFIG_FIH_FXX
		fih_printk(serial_debug_mask, FIH_DEBUG_ZONE_G0, "serial_debugger: could not install signal_irq\n");
#else
		printk(KERN_ERR
...
/* FIH, Debbie, 2010/01/04 { */
#ifdef CONFIG_FIH_FXX
		fih_printk(serial_debug_mask, FIH_DEBUG_ZONE_G0, "enable FIQ serial debugger\n");
#else
...
/* FIH, Debbie, 2010/01/04 { */
#ifdef CONFIG_FIH_FXX
	fih_printk(serial_debug_mask, FIH_DEBUG_ZONE_G0, "disable FIQ serial debugger\n");
#else
