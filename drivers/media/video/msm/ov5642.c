...
static struct wake_lock ov5642_wake_lock_suspend;
...
#ifdef CONFIG_FIH_FXX
#define OV5642_CAPTURE_FRAMERATE 750
#define OV5642_PREVIEW_FRAMERATE 2300
int ov5642_m_60Hz=0;
#endif
/* } FIH, Charles Huang, 2009/07/29 */
	...
	unsigned char *txdata, int length)
{
	...
	if (i2c_transfer(ov5642_client->adapter, msg, 1) < 0) {
		CAM_USER_G0(KERN_ERR "ov5642_i2c_txdata failed, try again!\n");
		if (i2c_transfer(ov5642_client->adapter, msg, 1) < 0) {
			CAM_USER_G0(KERN_ERR "ov5642_i2c_txdata failed\n");
	...
	unsigned char *rxdata, int length)
{
	...
	if (i2c_transfer(ov5642_client->adapter, msgs, 2) < 0) {
		CAM_USER_G0(KERN_ERR "ov5642_i2c_rxdata failed, try again!\n");
		if (i2c_transfer(ov5642_client->adapter, msgs, 2) < 0) {
			CAM_USER_G0(KERN_ERR "ov5642_i2c_rxdata failed!\n");
...
/* [FXX_CR], Calculate AEC */
#ifdef CONFIG_FIH_FXX
	{
		...
		CAM_USER_G0(KERN_INFO "ov5642 R0x350bpreview = 0x%x\n", R0x350bpreview);
		CAM_USER_G0(KERN_INFO "ov5642 R0x5690preview = 0x%x\n", R0x5690preview);
...
/* [FXX_CR], flashlight function  */
#ifdef CONFIG_FIH_FXX
		CAM_USER_G0(KERN_INFO "snapshot ov5642 ov5642_m_ledmod = %d\n", ov5642_m_ledmod);
...
/* [FXX_CR], add VFS */
			...
			CAM_USER_G0(KERN_INFO "ov5642 m_iFlashWrite0x350b = 0x%x\n", m_iFlashWrite0x350b);
			CAM_USER_G0(KERN_INFO "ov5642 m_iFlashWrite0x3502 = 0x%x\n", m_iFlashWrite0x3502);
			CAM_USER_G0(KERN_INFO "ov5642 m_iFlashWrite0x3501 = 0x%x\n", m_iFlashWrite0x3501);
			CAM_USER_G0(KERN_INFO "ov5642 m_iFlashWrite0x3500 = 0x%x\n", m_iFlashWrite0x3500);
			...
			CAM_USER_G0(KERN_INFO "ov5642 m_iFlashRead0x350b = 0x%x\n", m_iFlashWrite0x350b);
			CAM_USER_G0(KERN_INFO "ov5642 m_iFlashRead0x3502 = 0x%x\n", m_iFlashWrite0x3502);
			CAM_USER_G0(KERN_INFO "ov5642 m_iFlashRead0x3501 = 0x%x\n", m_iFlashWrite0x3501);
			CAM_USER_G0(KERN_INFO "ov5642 m_iFlashRead0x3500 = 0x%x\n", m_iFlashWrite0x3500);
...
/* } FIH, Charles Huang, 2009/09/01 */
		...
		CAM_USER_G0(KERN_INFO "ov5642 R0x350b = 0x%x\n", R0x350b);
		CAM_USER_G0(KERN_INFO "ov5642 R0x3502 = 0x%x\n", R0x3502);
		CAM_USER_G0(KERN_INFO "ov5642 R0x3501 = 0x%x\n", R0x3501);
		CAM_USER_G0(KERN_INFO "ov5642 R0x3500 = 0x%x\n", R0x3500);
		CAM_USER_G0(KERN_INFO "ov5642 Rpre0x350c = 0x%x\n", Rpre0x350c);
		CAM_USER_G0(KERN_INFO "ov5642 Rpre0x350d = 0x%x\n", Rpre0x350d);
		...
		CAM_USER_G0(KERN_INFO "ov5642 Gain = 0x%x\n", Gain);
		CAM_USER_G0(KERN_INFO "ov5642 ExposureLow = 0x%x\n", ExposureLow);
		CAM_USER_G0(KERN_INFO "ov5642 ExposureMid = 0x%x\n", ExposureMid);
		CAM_USER_G0(KERN_INFO "ov5642 ExposureHigh = 0x%x\n", ExposureHigh);
		CAM_USER_G0(KERN_INFO "ov5642 PreviewMaxlineHigh = 0x%x\n", PreviewMaxlineHigh);
		CAM_USER_G0(KERN_INFO "ov5642 PreviewMaxlineLow = 0x%x\n", PreviewMaxlineLow);
...
/* } FIH, Charles Huang, 2009/06/24 */
		...
		CAM_USER_G0(KERN_INFO "ov5642 Rcap0x350c = 0x%x\n", Rcap0x350c);
		CAM_USER_G0(KERN_INFO "ov5642 Rcap0x350d = 0x%x\n", Rcap0x350d);

		CaptureMaxlineHigh=Rcap0x350c;
		CaptureMaxlineLow=Rcap0x350d;

		CAM_USER_G0(KERN_INFO "ov5642 CaptureMaxlineHigh = 0x%x\n", CaptureMaxlineHigh);
		CAM_USER_G0(KERN_INFO "ov5642 CaptureMaxlineLow = 0x%x\n", CaptureMaxlineLow);


		Preview_Maxlines = 256*PreviewMaxlineHigh + PreviewMaxlineLow;
		Capture_MaxLines = 256*CaptureMaxlineHigh + CaptureMaxlineLow;
		CAM_USER_G0(KERN_INFO "ov5642 ov5642_m_60Hz = 0x%x\n", ov5642_m_60Hz);
...
#endif
/* } FIH, Charles Huang, 2009/06/24 */
		CAM_USER_G0(KERN_INFO "ov5642 m_iWrite0x350b = 0x%x\n", m_iWrite0x350b);
		CAM_USER_G0(KERN_INFO "ov5642 m_iWrite0x3502 = 0x%x\n", m_iWrite0x3502);
		CAM_USER_G0(KERN_INFO "ov5642 m_iWrite0x3501 = 0x%x\n", m_iWrite0x3501);
		CAM_USER_G0(KERN_INFO "ov5642 m_iWrite0x3500 = 0x%x\n", m_iWrite0x3500);
		...
		CAM_USER_G0(KERN_INFO "ov5642 m_iRead0x350b = 0x%x\n", m_iWrite0x350b);
		CAM_USER_G0(KERN_INFO "ov5642 m_iRead0x3502 = 0x%x\n", m_iWrite0x3502);
		CAM_USER_G0(KERN_INFO "ov5642 m_iRead0x3501 = 0x%x\n", m_iWrite0x3501);
		CAM_USER_G0(KERN_INFO "ov5642 m_iRead0x3500 = 0x%x\n", m_iWrite0x3500);
...
/* } FIH, Charles Huang, 2010/03/01 */
	...
	printk(KERN_DEBUG "[Camera] ov5642: init wakelock\r\n");
	wake_lock_init(&ov5642_wake_lock_suspend, WAKE_LOCK_SUSPEND, "ov5642");
	printk(KERN_DEBUG "[Camera] ov5642: lock SUSPEND...\r\n");
	wake_lock(&ov5642_wake_lock_suspend);
...
int ov5642_sensor_config(void __user *argp)
{
	...
	/* down(&ov5642_sem); */
	CAM_USER_G1("ov5642_sensor_config, cfgtype = %d, mode = %d\n",
		cfg_data.cfgtype, cfg_data.mode);

	CDBG("ov5642_sensor_config, cfgtype = %d, mode = %d\n",
		cfg_data.cfgtype, cfg_data.mode);
...
/* } FIH, Charles Huang, 2010/03/01 */
	...
	printk(KERN_DEBUG "[Camera] ov5642: unlock SUSPEND\r\n");
	wake_unlock(&ov5642_wake_lock_suspend);
	printk(KERN_DEBUG "[Camera] ov5642: destroy wakelock\r\n");
	wake_lock_destroy(&ov5642_wake_lock_suspend);
...
{
	int ret ;
	CAM_USER_G0(KERN_INFO "ov5642 :kobject creat and add\n");
	android_ov5642 = kobject_create_and_add("android_camera", NULL);
	if (android_ov5642 == NULL) {
		CAM_USER_G0(KERN_ERR "ov5642_sysfs_init: subsystem_register " \
		"failed\n");
		ret = -ENOMEM;
		return ret ;
	}
	CAM_USER_G0(KERN_INFO "ov5642:sysfs_create_file\n");

	ret = sysfs_create_file(android_ov5642, &dev_attr_initreg_5642.attr);
	if (ret) {
		CAM_USER_G0(KERN_ERR "ov5642_sysfs_init: sysfs_create_file " \
		"failed\n");
...
static enum hrtimer_restart ov5642_flashled_timer_func(struct hrtimer *timer)
{
	...
	CAM_USER_G0(KERN_INFO "ov5642_flashled_timer_func ov5642_m_ledmod = %d\n", ov5642_m_ledmod);
...
static int ov5642_flashled_off_thread(void *arg)
{
	...
	CAM_USER_G0(KERN_INFO "%s: ov5642_flashled_off_thread running\n", __func__);
...
/* [FXX_CR], suspend/resume for pm */
	...
	CAM_USER_G0(KERN_INFO "ov5642_suspend!\n");
	if (ov5642_ctrl)
	{
		CAM_USER_G0(KERN_INFO "ov5642 power down high!\n");
...
/* [FXX_CR], suspend/resume for pm */
	...
	CAM_USER_G0(KERN_INFO "ov5642_resume!\n");
	if (ov5642_ctrl)
	{
		CAM_USER_G0(KERN_INFO "ov5642 power down low!\n");
		gpio_direction_output(31,0);
		CAM_USER_G0("[OV5642 5M]  gpio_get_value(31) = %d\n", gpio_get_value(31));
	}
#endif
/* } FIH, Charles Huang, 2009/06/25 */
	return 0;
