...
static struct wake_lock ov3642_wake_lock_suspend;
...
/* } FIH, Charles Huang, 2010/03/01 */
	...
	printk(KERN_DEBUG "[Camera] ov3642: init wakelock\r\n");
	wake_lock_init(&ov3642_wake_lock_suspend, WAKE_LOCK_SUSPEND, "ov3642");
	printk(KERN_DEBUG "[Camera] ov3642: lock SUSPEND...\r\n");
	wake_lock(&ov3642_wake_lock_suspend);
...
/* } FIH, Charles Huang, 2010/03/01 */
	...
	printk(KERN_DEBUG "[Camera] ov3642: unlock SUSPEND\r\n");
	wake_unlock(&ov3642_wake_lock_suspend);
	printk(KERN_DEBUG "[Camera] ov3642: destroy wakelock\r\n");
	wake_lock_destroy(&ov3642_wake_lock_suspend);
