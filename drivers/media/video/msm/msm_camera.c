...
int cam_debug_mask = 0;
module_param_named(debug_mask, cam_debug_mask, uint, S_IWUSR | S_IRUGO);
#endif
/* } FIH, Charles Huang, 2009/12/28 */
...
#ifdef CONFIG_FIH_FXX
		{
			pr_err("msm_camera_get_picture -ETIMEDOUT, rc = %d\n", rc);
#endif
/* } FIH, Charles Huang, 2009/09/01 */
			return -ETIMEDOUT;
/* FIH, Charles Huang, 2009/09/01 { */
