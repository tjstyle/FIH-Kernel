...
struct ov3640_reg {
	struct ov3640_i2c_reg_conf const *init_settings_tbl;
	uint16_t init_settings_tbl_size;
	struct ov3640_i2c_reg_conf const *preview_settings_tbl;
	uint16_t preview_settings_tbl_size;
	struct ov3640_i2c_reg_conf const *snapshot_settings_tbl;
	uint16_t snapshot_settings_tbl_size;
	struct ov3640_i2c_reg_conf const *noise_reduction_reg_settings_tbl;
	...
	uint16_t rftbl_size;
	struct ov3640_i2c_reg_conf const *oem_settings_tbl;
	uint16_t oem_settings_tbl_size;
	struct ov3640_i2c_reg_conf const *iq_settings_tbl;
	uint16_t iq_settings_tbl_size;
	struct ov3640_i2c_reg_conf const *gseolens_settings_tbl;
	uint16_t gseolens_settings_tbl_size;
	struct ov3640_i2c_reg_conf const *grdlens_settings_tbl;
	uint16_t grdlens_settings_tbl_size;
	struct ov3640_i2c_reg_conf const *af_init_settings_tbl;
