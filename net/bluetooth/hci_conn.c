...
void hci_setup_sync(struct hci_conn *conn, __u16 handle)
{
	...
	cp.handle   = cpu_to_le16(handle);
//for specific headset(ex:SEEHOT_SX912),delay SCO link issue+++
        // SW2-6-1-CC-Disable 3-EV3, 3-EV5 packets in Bluez stack for eSCO *[
	cp.pkt_type = cpu_to_le16(conn->pkt_type | 0x0280);
        // SW2-6-1-CC-Disable 3-EV3, 3-EV5 packets in Bluez stack for eSCO *]
//for specific headset,delay SCO link issue---
